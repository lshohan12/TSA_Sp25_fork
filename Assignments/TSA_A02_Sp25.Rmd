...
```{r}
#can do three seperate ts for each one
...
```{r}
#interpret - describe observations about it
...
```{r}
#coorelation between all 3 variables
...
```{r}
#ACF 
#are they decaying? going up and down with seasonality? 
